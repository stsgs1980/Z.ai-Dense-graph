...
import type { LayoutAdviceInput, ParsedPrompt } from '@/features/layout/lib/layout/types'
import { GOALS, CATEGORIES, categoryMeta } from '@/features/layout/lib/layout/types'
...
export function ExplorerSidebar({
  ...
  return (
    <nav aria-label="Навигация по компонентам" style={{
