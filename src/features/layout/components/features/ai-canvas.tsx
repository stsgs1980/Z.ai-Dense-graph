...
import { GOALS, PROMPT_EXAMPLES } from '@/features/layout/lib/layout/types'
import { useCanvasPrompt } from '@/features/layout/lib/layout/use-canvas-prompt'
...
import { colors, radius, spacing, fontSize, fontWeight } from '@/features/layout/lib/layout/tokens'
