...
export function KPIStrip({ quickStats }: { quickStats?: typeof QUICK_STATS }) {
  ...
  return (
    <div
      data-src="src/components/dashboard/kpi-strip.tsx"
      style={{
        display: 'grid',
      ...
      {kpis.map((kpi, idx) => (
        <div
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = `0 0 20px ${kpi.color}08, inset 0 1px 0 ${kpi.color}10`
          }}
          onMouseLeave={(e) => {
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 9, color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.8px', fontWeight: 600 }}>
              {kpi.label}
            </span>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 8 }}>
            <div>
              <span style={{ fontSize: 26, fontWeight: 800, color: kpi.color, lineHeight: 1, letterSpacing: '-0.5px' }}>
                {kpi.value}
              </span>
              <div style={{ fontSize: 9, color: kpi.changeColor, marginTop: 4, fontWeight: 500 }}>
                {kpi.change}
              </div>
            </div>
          ...
          <div
            style={{
              ...
              right: 0,
              height: 40,
              background: `linear-gradient(to top, ${kpi.color}04, transparent)`,
              pointerEvents: 'none',
            }}
          />
        </div>
